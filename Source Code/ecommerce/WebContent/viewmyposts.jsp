...
<br>
	...
	<div class="container" id="display">
		...
		<c:forEach items="${posts}" var="posts">
             ...
             <tr>
				<td><c:out value="${posts.postid}"></c:out></td>
			    <td><c:out value='${posts.cid}'></c:out></td>
			    <td><c:out value="${posts.about}"></c:out></td>
			    <td><c:out value="${posts.postdesc}"></c:out></td>
			    <td><c:out value="${posts.quantity}"></c:out></td>
			    <td><c:out value="${posts.price}"></c:out></td>
			    <td><c:out value="${posts.createdat}"></c:out>
			     <a href="requestbids?upid=${posts.postid}" alt="Bid">View Bids</a>
			   </td>
			</tr>
