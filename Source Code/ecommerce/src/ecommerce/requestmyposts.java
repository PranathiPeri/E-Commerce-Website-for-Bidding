...
/**
 * Servlet implementation class requestmyposts
 */
@WebServlet("/requestmyposts")
public class requestmyposts extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public requestmyposts() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		log.info("In Request My Posts servlet");
		
		 System.out.println("I am in request My Post servlet");
		 ...
		 if (cliresponse.getStatus() != 200) {
			...
			log.info("Retrieved my Posts,so redirecting to viewmyposts page");
			
			RequestDispatcher rd=request.getRequestDispatcher("viewmyposts.jsp");
